...
func (fake *FakePlansFetcher) GetPlans(arg1 string) ([]*osbapi.Plan, error) {
...
func (fake *FakePlansFetcher) GetPlansCallCount() int {
	fake.getPlansMutex.RLock()
	defer fake.getPlansMutex.RUnlock()
	return len(fake.getPlansArgsForCall)
}

func (fake *FakePlansFetcher) GetPlansCalls(stub func(string) ([]*osbapi.Plan, error)) {
	fake.getPlansMutex.Lock()
	defer fake.getPlansMutex.Unlock()
	fake.GetPlansStub = stub
}

func (fake *FakePlansFetcher) GetPlansArgsForCall(i int) string {
	fake.getPlansMutex.RLock()
	defer fake.getPlansMutex.RUnlock()
...
func (fake *FakePlansFetcher) GetPlansReturns(result1 []*osbapi.Plan, result2 error) {
	fake.getPlansMutex.Lock()
	defer fake.getPlansMutex.Unlock()
...
func (fake *FakePlansFetcher) GetPlansReturnsOnCall(i int, result1 []*osbapi.Plan, result2 error) {
	fake.getPlansMutex.Lock()
	defer fake.getPlansMutex.Unlock()
	fake.GetPlansStub = nil
...
func (fake *FakePlansFetcher) Invocations() map[string][][]interface{} {
...
func (fake *FakePlansFetcher) recordInvocation(key string, args []interface{}) {
...
var _ usecases.PlansFetcher = new(FakePlansFetcher)
