...
type FakeServicesFetcher struct {
...
func (fake *FakeServicesFetcher) GetServices(arg1 string) ([]*osbapi.Service, error) {
...
func (fake *FakeServicesFetcher) GetServicesCallCount() int {
	fake.getServicesMutex.RLock()
	defer fake.getServicesMutex.RUnlock()
	return len(fake.getServicesArgsForCall)
}

func (fake *FakeServicesFetcher) GetServicesCalls(stub func(string) ([]*osbapi.Service, error)) {
	fake.getServicesMutex.Lock()
	defer fake.getServicesMutex.Unlock()
	fake.GetServicesStub = stub
}

func (fake *FakeServicesFetcher) GetServicesArgsForCall(i int) string {
	fake.getServicesMutex.RLock()
	defer fake.getServicesMutex.RUnlock()
...
func (fake *FakeServicesFetcher) GetServicesReturns(result1 []*osbapi.Service, result2 error) {
	fake.getServicesMutex.Lock()
	defer fake.getServicesMutex.Unlock()
...
func (fake *FakeServicesFetcher) GetServicesReturnsOnCall(i int, result1 []*osbapi.Service, result2 error) {
	fake.getServicesMutex.Lock()
	defer fake.getServicesMutex.Unlock()
	fake.GetServicesStub = nil
...
func (fake *FakeServicesFetcher) Invocations() map[string][][]interface{} {
...
func (fake *FakeServicesFetcher) recordInvocation(key string, args []interface{}) {
...
var _ usecases.ServicesFetcher = new(FakeServicesFetcher)
